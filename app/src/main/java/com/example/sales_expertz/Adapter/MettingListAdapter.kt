...
class MettingListAdapter(
    ...
    override fun onCreateViewHolder(
        ...
        val v =
            LayoutInflater.from(parent.context).inflate(com.example.sales_expertz.R.layout.item_metting_list, parent, false)
    ...
    inner class MyViewHolder(itemview: View) : RecyclerView.ViewHolder(itemview) {
        ...
        val tvMobile: TextView = itemview.findViewById(com.example.sales_expertz.R.id.tvMobile)
        val tvContactPerson: TextView = itemview.findViewById(com.example.sales_expertz.R.id.tvContactPerson)
        val tvStartTime: TextView = itemview.findViewById(com.example.sales_expertz.R.id.tvStartTime)
        val tvStopTime: TextView = itemview.findViewById(com.example.sales_expertz.R.id.tvStopTime)
        val tvStartLocation: TextView = itemview.findViewById(com.example.sales_expertz.R.id.tvStartLocation)
        val tvStopLocation: TextView = itemview.findViewById(com.example.sales_expertz.R.id.tvStopLocation)
        val tvAddress: TextView = itemview.findViewById(com.example.sales_expertz.R.id.tvAddress)
        val tvRemark: TextView = itemview.findViewById(com.example.sales_expertz.R.id.tvRemark)
        val tvStopMeeting: TextView = itemview.findViewById(com.example.sales_expertz.R.id.tvStopMeeting)
